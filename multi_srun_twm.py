...
Arguments:
  ...
  multi_script -- script to execute multiple times (default is "pySAMM_v2.py")
...
def main():
    ...
    if len(sys.argv) == 1:
        file_list = os.getenv('ARG1', '~/tmp/file_list.txt')
        multi_script = os.getenv('ARG2', 'input_file_generator.py')
    elif len(sys.argv) == 2:
